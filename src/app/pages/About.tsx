    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 py-16 transition-colors">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-rose-500/10 rounded-xl mb-6 shadow-sm">
        ...
        {/* Company Story */}
        <div className="bg-white dark:bg-slate-900 rounded-xl p-8 border border-rose-200 dark:border-slate-800 mb-12 shadow-md transition-colors">
        ...
        {/* Stats */}
        <div className="bg-gradient-to-r from-rose-600 via-pink-600 to-purple-600 rounded-xl p-8 text-center mb-12 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <div className="text-rose-100">Godina Osnivanja</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-white mb-2">150+</div>
              <div className="text-rose-100">Završenih Poslova</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-white mb-2">100%</div>
              <div className="text-rose-100">Pravna Podrška</div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start space-x-3">
              <div className="bg-rose-500/10 p-2 rounded-lg flex-shrink-0">
                <HomeIcon className="h-5 w-5 text-rose-600 dark:text-rose-400" />
              </div>
              <div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl p-8 border border-rose-200 dark:border-slate-800 mb-12 shadow-md transition-colors">
          <div className="flex items-start space-x-4">
            <div className="bg-rose-500/10 p-3 rounded-lg flex-shrink-0">
              <Scale className="h-6 w-6 text-rose-600 dark:text-rose-400" />
            </div>
            <div>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Zašto Je Pravna Podrška Važna?</h3>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                Kupovina ili prodaja nekretnine je često najveća finansijska transakcija u životu. Pravni aspekti mogu biti kompleksni - od provere vlasništva, preko ugovaranja, do predaje poseda. 
              </p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                Naš advokatski tim eliminiše sve rizike i osigurava da vaša investicija bude zaštićena. Ova usluga je uključena u naš servis, što znači da ne plaćate dodatno za mir koji dobijate.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Contact CTA */}
        <div className="bg-white dark:bg-slate-900 rounded-xl p-8 border border-rose-200 dark:border-slate-800 text-center shadow-md transition-colors">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="inline-flex items-center space-x-2 bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-700 hover:to-pink-700 text-white px-6 py-3 rounded-lg transition-all shadow-md hover:shadow-lg"
            >
            ...
            <a
              ...
              className="inline-flex items-center space-x-2 bg-rose-50 dark:bg-slate-800 hover:bg-rose-100 dark:hover:bg-slate-700 text-gray-900 dark:text-white px-6 py-3 rounded-lg transition-colors border border-rose-200 dark:border-slate-700 shadow-sm"
            >
