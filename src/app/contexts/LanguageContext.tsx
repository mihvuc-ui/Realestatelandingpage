...
const translations: Record<Language, any> = {
  sr: {
    ...
    hero: {
      ...
      completedDeals: 'Realizovanih Poslova',
    ...
    buying: {
      ...
      subtitle: 'Opišite kakvu nekretninu tražite i mi ćemo pronaći savršeno rešenje za vas',
    ...
    selling: {
      ...
      subtitle: 'Opišite vašu nekretninu i mi ćemo je brzo prodati po najboljoj ceni',
      personalInfo: 'Vaši Podaci',
      name: 'Ime i Prezime',
      phone: 'Telefon',
      email: 'Email',
    ...
    rentiranje: {
      title: 'Pronađite Stan za Iznajmljivanje',
      subtitle: 'Pretražite najbolje stanove za rentiranje u Beogradu',
      ...
      twoRooms: '2 Sobe',
      threeRooms: '3 Sobe',
      fourPlusRooms: '4+ Sobe',
      maxRent: 'Maksimalna mesečna kirija',
      properties: 'stanova',
      pageTitle: 'Rentiranje Stanova - Nekretnine Stepenik',
      pageDescription: 'Pronađite savršen stan za rentiranje u Beogradu. Najbolja ponuda stanova za iznajmljivanje.',
      pageKeywords: 'rentiranje stanova beograd, iznajmljivanje stanova, stanovi za rent, kirija stanova',
    },
    featured: {
    ...
    browse: {
      ...
      sqmDesc: 'Površina: Najveća prvo',
      maxPrice: 'Maksimalna cena',
      maxArea: 'Maksimalna površina',
      paymentMethod: 'Način plaćanja',
      allPaymentMethods: 'Svi načini',
      cash: 'Gotovina',
      credit: 'Kredit',
      resultsCount: 'nekretnina pronađeno',
      noResults: 'Nema rezultata',
      noResultsText: 'Pokušajte sa drugim filterima',
      showing: 'Prikazuje se',
      properties: 'nekretnina',
      resetFilters: 'Obriši sve filtere',
      noPropertiesFound: 'Nema nekretnina koje odgovaraju vašim kriterijumima.',
    },
    listing: {
      perMonth: 'mesečno',
      bedrooms: 'Broj Soba',
  ...
  en: {
    ...
    rentiranje: {
      title: 'Find an Apartment for Rent',
      subtitle: 'Search for the best apartments for rent in Belgrade',
      ...
      pageTitle: 'Apartment Rentals - Nekretnine Stepenik',
      pageDescription: 'Find your perfect apartment for rent in Belgrade. Best offer for apartment rentals.',
      pageKeywords: 'apartment rentals belgrade, rent apartments, apartments for rent, apartment rent',
    },
    featured: {
    ...
    browse: {
      title: 'Our Offerings',
      subtitle: 'Explore our carefully selected collection of properties',
      searchPlaceholder: 'Search by name or location...',
      filters: 'Filters',
      newest: 'Newest',
      priceAsc: 'Price: Lowest first',
      priceDesc: 'Price: Highest first',
      sqmDesc: 'Area: Largest first',
      maxPrice: 'Max Price',
      maxArea: 'Max Area',
      ...
      noResultsText: 'Try different filters',
      showing: 'Showing',
      properties: 'properties',
      resetFilters: 'Reset all filters',
      noPropertiesFound: 'No properties match your criteria.',
    },
    listing: {
      perMonth: 'per month',
      bedrooms: 'Bedrooms',
  ...
  ru: {
    ...
    cta: {
      title: 'Найдем Ваш Идеальнй Дом Вместе',
    ...
    buying: {
      ...
      subtitle: 'Опишите нам, какую недвижимость вы ищете, и м найдем идеальное решение для вас',
    ...
    rentiranje: {
      title: 'Найдите Квартиру для Аренды',
      subtitle: 'Ищите лучшие квартиры для аренды в Белграде',
      ...
      fourPlusRooms: '4+ Комнат',
      maxRent: 'Максимальная Месячная Арендная Плата',
      properties: 'квартир',
      pageTitle: 'Аренда Квартир - Nekretnine Stepenik',
      pageDescription: 'Найдите идеальную квартиру для аренды в Белграде. Лучшее предложение для аренды квартир.',
      pageKeywords: 'аренда квартир белград, аренда недвижимости, квартиры для аренды, аренда квартиры',
    },
    featured: {
    ...
    browse: {
      ...
      sqmDesc: 'Площадь: Большая первая',
      ...
      cash: 'Наличные',
      credit: 'Кредит',
      resultsCount: 'найдено недвижимостей',
      noResults: 'Нет результатов',
      noResultsText: 'Попробуйте другие фильтры',
      showing: 'Показано',
      properties: 'недвижимостей',
      resetFilters: 'Сбросить все фильтры',
      noPropertiesFound: 'Нет недвижимостей, соответствующих вашим критериям.',
    },
    listing: {
      perMonth: 'в месяц',
      bedrooms: 'Спальни',
  ...
  tr: {
    ...
    hero: {
      ...
      subtitle: 'Gayrimenkul, atlamadan, iyi düşünülmüş bir yükseltmedir. Her karar ilk adm ile başlar.',
      forSale: 'Satılık',
      forRent: 'Kiralık',
    ...
    rentiranje: {
      title: 'Kiralık Daire Bulun',
      subtitle: 'Belgrad\'da en iyi daireleri kiralama için arayın',
      ...
      threeRooms: '3 Oda',
      fourPlusRooms: '4+ Oda',
      maxRent: 'Maksimum Aylık Kir',
      properties: 'daire',
      pageTitle: 'Daire Kiralama - Nekretnine Stepenik',
      pageDescription: 'Belgrad\'da mükemmel bir daire kiralayın. Kiralama için en iyi daire teklifleri.',
      pageKeywords: 'belgrad daire kiralama, daire kiralaması, kiralık daireler, daire kirası',
    },
    featured: {
    ...
    browse: {
      ...
      filters: 'Filtreler',
      newest: 'En Yeni',
      priceAsc: 'Fiyat: En Düşük',
      priceDesc: 'Fiyat: En Yüksek',
      sqmDesc: 'Alan: En Büyk',
      ...
      cash: 'Nakit',
      credit: 'Kredi',
      resultsCount: 'emlak bulundu',
      noResults: 'Sonuç bulunamadı',
      noResultsText: 'Farklı filtreler deneyin',
      showing: 'Gösteriliyor',
      properties: 'emlak',
      resetFilters: 'Tüm filtreleri sıfırla',
      noPropertiesFound: 'Kriterlerinize uygun emlak bulunamadı.',
    },
    listing: {
      perMonth: 'aylık',
