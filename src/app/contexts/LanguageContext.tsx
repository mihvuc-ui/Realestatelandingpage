...
const translations: Record<Language, any> = {
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: 'Nekretnine are not a leap, but a well-thought-out ascent. Every decision starts with the first step.',
      forSale: 'For Sale',
      forRent: 'For Rent',
      viewListings: 'View listings',
      badge: 'Stepenik Real Estate Agency',
      headline: 'The right step between',
      headlineAccent: 'offer and decision',
